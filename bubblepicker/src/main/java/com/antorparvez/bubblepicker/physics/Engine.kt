package com.antorparvez.bubblepicker.physics

import com.antorparvez.bubblepicker.rendering.Item
import com.antorparvez.bubblepicker.sqr
...
object Engine {
    ...
    var radius = 50
        set(value) {
            field = value
            bubbleRadius = interpolate(0.15f, 0.25f, value / 100f)
            gravity = interpolate(30f, 80f, value / 100f)
